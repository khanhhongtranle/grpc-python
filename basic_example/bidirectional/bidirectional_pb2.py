...
_BIDIRECTIONALSERVICE = _descriptor.ServiceDescriptor(
  name='BidirectionalService',
  full_name='bidirectional.BidirectionalService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='bidirectional.BidirectionalService.GetServerResponse',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_BIDIRECTIONALSERVICE)

DESCRIPTOR.services_by_name['BidirectionalService'] = _BIDIRECTIONALSERVICE
