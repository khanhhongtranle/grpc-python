...
class BidirectionalServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.stream_stream(
                '/bidirectional.BidirectionalService/GetServerResponse',
...
def add_BidirectionalServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'bidirectional.BidirectionalService', rpc_method_handlers)
...
class BidirectionalService(object):
    ...
    def GetServerResponse(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/bidirectional.BidirectionalService/GetServerResponse',
